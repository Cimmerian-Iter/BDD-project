...
if(isset($_POST["nom"]) && isset($_POST["prenom"]) && isset($_POST["adresse_postale"]) && isset($_POST["adresse_mail"]) && isset($_POST["num_tel"]) && isset($_POST["nb_occupants"]) && isset($_POST["date_debut_sejour"]) && isset($_POST["date_fin_sejour"]) && isset($_POST["type_bungalow"]) && isset($_POST["mode_paiement"])){
	...
	if ($username_verify->rowCount() == 0){

        if(preg_match("#0[0-9]{1} [0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}#", $num_tel) == 1) {

            $mail_verify = sendQuery("SELECT * FROM Clients WHERE adresse_mail_client = '$adresse_mail'");

            if(filter_var($adresse_mail, FILTER_VALIDATE_EMAIL) && $mail_verify->rowCount() == 0){                
                        ...
                        if($type_bungalow == "Oasis" || $type_bungalow == "Pacifique"){
                            ...
                            if($nb_occupants >= 1 && $nb_occupants <= 4){
                                ...
                                if($mode_paiement == "Carte bancaire" || $mode_paiement == "Chèque"){
                                    ...
                                    sendQuery("INSERT INTO Clients (nom_client, prenom_client, adresse_postale_client, adresse_mail_client, num_tel_client) VALUES ('$nom', '$prenom', '$adresse_postale', '$adresse_mail', '$num_tel')");
                ...
                $error = "Votre adresse mail est incorrecte ou est déjà utilisée.";
        ...
        $error = "Vous possédez déjà un compte.";
...
if($success) {
    ...
    <section class=\"section\">
        <div class=\"container\">
            ...
            <div class=\"control\">
                <a class=\"button is-link\" href=\"connexion.php\">Accéder à l'espace de connexion</a>
            </div>
            <div class=\"control\">
    ...
    <section class=\"section\">
        <div class=\"container\">
            ...
            <div class=\"field is-grouped\">
            <div class=\"control\">
                <a class=\"button is-link\" href=\"reservation.php\">Réessayer</a>
            </div>
            <div class=\"control\">
              <a class=\"button is-link is-light\" href=\"index.php\">Retourner à l'accueil</a>
            </div>
